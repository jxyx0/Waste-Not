'''
This code is from assignment code for FIT2107 Software Quality and Testing
...
def read_password(prompt):
    '''
    Read a string value from the user. Continue prompting the
    user until they enter a valid string value that has more than
    8 characters.
        Args:
            prompt (string): a message to print to the user.

        Return:
            the string value the user entered.
    '''
    line = read_string(prompt)
    while len(line) < 8:
